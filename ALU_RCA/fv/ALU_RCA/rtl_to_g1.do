...
usage -auto
set log file fv/ALU_RCA/rtl_to_g1.log -replace
// tclmode
...
vpx read guide file fv/ALU_RCA/rtl_to_g1.ovf
...
set root module ALU_RCA -golden
read design -verilog \
	-unzip fv/ALU_RCA/g1.v.gz \
	-revised -lastmod
set root module ALU_RCA -revised
report design data
report black box
...
write hier_compare dofile fv/ALU_RCA/hier_rtl_to_g1.do \
...
run hier_compare fv/ALU_RCA/hier_rtl_to_g1.do
usage
